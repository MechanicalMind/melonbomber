...
GM.PrepTime = CreateConVar("mb_time_prep", 5, bit.bor(0), "Time to wait before round starts (default 5)" )
GM.EndTime = CreateConVar("mb_time_end", 10, bit.bor(0), "Time to show player table (default 10)" )
